...
export default class IcePalaceMap extends React.Component {
  constructor(props, context) {
    super(props, context);

    this.floors = ['B7', 'B6', 'B5', 'B4', 'B3', 'B2', 'B1', '1F'];
    this.mapName = 'ice-palace';
  ...
  initMap(floorImages) {
    ...
    const allowedBounds = new this.google.maps.LatLngBounds( // eslint-disable-line
      new this.google.maps.LatLng(66.5483, -179),
      new this.google.maps.LatLng(85, -90.0879)
    );
